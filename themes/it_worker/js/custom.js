 ...
 *  =======================================*/
 function addclasstoimage() {
    ...
    jQuery("#about .field--name-field-image img").addClass('image img-circle img-responsive');
 ...
 *  =======================================*/
 function fullScreenContainer() {
   ...
   jQuery("#intro,#block-introductionblock .field--name-field-background-image img").css({
       width: screenWidth,
       height: screenHeight
   });
   jQuery("#banner-wrapper, #block-bloglistbanner .field--name-field-background-image img").css({
       width: screenWidth,
       height: '200px'
   });
}
